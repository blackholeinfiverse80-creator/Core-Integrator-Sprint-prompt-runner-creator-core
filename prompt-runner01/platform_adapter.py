...
from platform_publisher import InstructionPublisher
...
class PlatformAdapter:
    ...
    def __init__(self, plugins_dir: Path = PLUGINS_DIR):
        ...
        self.version = "2.0.0"
        self.publisher = InstructionPublisher(Path(__file__).parent)
    ...
    def process(
        ...
        try:
            ...
            if publish:
                delivery = self.publisher.publish(instruction.to_dict())
